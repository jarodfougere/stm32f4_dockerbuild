...
is to be placed at section "intvec" in the linker script 
*/
#pragma location = ".intvec"
const union vectorTableEntry __vector_table[] = 
{ 
  /* stack pointer unioned */
  { .initial_stack_pointer = __sfe( "CSTACK" ) }, /* exception 0: startup  */  
  __iar_program_start,                            /* exception 1: reset    */
  NMI_Handler,                                    /* exception 2: NMI fault */
  HardFault_Handler,
  MemManage_Handler,
  BusFault_Handler,
  UsageFault_Handler,
