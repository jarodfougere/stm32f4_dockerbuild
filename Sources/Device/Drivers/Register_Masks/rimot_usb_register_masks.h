 ...
 * SCRUBBED FROM THE DATASHEET AND REFERENCE
 * MANUAL
 * 
 */
...
#define GCCFG_NO_VBUS_SENS_POS             (21U)                         
#define GCCFG_NO_VBUS_SENS_MSK             (0X1UL << GCCFG_NO_VBUS_SENS_POS) 
#define GCCFG_NO_VBUS_SENS                 GCCFG_NO_VBUS_SENS_MSK   
