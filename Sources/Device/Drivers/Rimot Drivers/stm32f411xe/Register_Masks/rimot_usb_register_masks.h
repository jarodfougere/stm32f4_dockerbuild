...
#define DCFG_PFIVL_FRAME_INTERVAL_80 (0U << (DCFG_PFIVL_POS))
#define DCFG_PFIVL_FRAME_INTERVAL_85 (1U << (DCFG_PFIVL_POS))
#define DCFG_PFIVL_FRAME_INTERVAL_90 (2U << (DCFG_PFIVL_POS))
#define DCFG_PFIVL_FRAME_INTERVAL_95 (3U << (DCFG_PFIVL_POS))
...
#define DSTS_ENUMSPD_FS  (0x03UL << DSTS_ENUMSPD_POS)
...
#define GRSTCTL_TXFNUM_ALL (0x10UL << GRSTCTL_TXFNUM_POS)
...
#define DIEPMSK_TOCM_POS (3U)
#define DIEPMSK_TOCM_MSK (0X1UL << DIEPMSK_TOCM_POS)
#define DIEPMSK_TOCM     DIEPMSK_TOCM_MSK
...
#define DAINT_IEPINT_EP0 (0x1UL << DAINT_IEPINT_POS)
#define DAINT_IEPINT_EP1 (0x2UL << DAINT_IEPINT_POS)
#define DAINT_IEPINT_EP2 (0x3UL << DAINT_IEPINT_POS)
#define DAINT_IEPINT_EP3 (0x4UL << DAINT_IEPINT_POS)

#define DAINT_OEPINT_POS (16U)
#define DAINT_OEPINT_MSK (0XFFFFUL << DAINT_OEPINT_POS)
#define DAINT_OEPINT     DAINT_OEPINT_MSK
#define DAINT_OEPINT_EP0 (0x1UL << DAINT_OEPINT_POS)
#define DAINT_OEPINT_EP1 (0x2UL << DAINT_OEPINT_POS)
#define DAINT_OEPINT_EP2 (0x3UL << DAINT_OEPINT_POS)
#define DAINT_OEPINT_EP3 (0x4UL << DAINT_OEPINT_POS)
...
#define GRXSTSP_DPID_DATA0 (0X0U << GRXSTSP_DPID_POS)
#define GRXSTSP_DPID_DATA1 (0X1U << GRXSTSP_DPID_POS)
#define GRXSTSP_DPID_DATA2 (0X2U << GRXSTSP_DPID_POS)
#define GRXSTSP_DPID_MDATA (0X3U << GRXSTSP_DPID_POS)

#define GRXSTSP_PKTSTS_POS                  (17U)
#define GRXSTSP_PKTSTS_MSK                  (0XFUL << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS                      GRXSTSP_PKTSTS_MSK
#define GRXSTSP_PKTSTS_HOSTMODE_IN_PKT      (0x02U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_HOSTMODE_IN_PKT_CPLT (0X03U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_HOSTMODE_PKT_TGLERR  (0x05U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_HOSTMODE_HC_HALT     (0x07U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_DEVMODE_GONAK        (0x01U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_DEVMODE_OUT_PKT      (0x02U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_DEVMODE_OUT_CPLT     (0x03U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_DEVMODE_STUP_PKT     (0x04U << GRXSTSP_PKTSTS_POS)
#define GRXSTSP_PKTSTS_DEVMODE_STUP_CPLT    (0x06U << GRXSTSP_PKTSTS_POS)
...
#define DAINTMSK_IEPM_EP0 (0x1UL << DAINTMSK_IEPM_POS)
#define DAINTMSK_IEPM_EP1 (0x2UL << DAINTMSK_IEPM_POS)
#define DAINTMSK_IEPM_EP2 (0x3UL << DAINTMSK_IEPM_POS)
#define DAINTMSK_IEPM_EP3 (0x4UL << DAINTMSK_IEPM_POS)

#define DAINTMSK_OEPM_POS (16U)
#define DAINTMSK_OEPM_MSK (0XFFFFUL << DAINTMSK_OEPM_POS)
#define DAINTMSK_OEPM     DAINTMSK_OEPM_MSK
#define DAINTMSK_OEPM_EP0 (0x1UL << DAINTMSK_OEPM_POS)
#define DAINTMSK_OEPM_EP1 (0x2UL << DAINTMSK_OEPM_POS)
#define DAINTMSK_OEPM_EP2 (0x3UL << DAINTMSK_OEPM_POS)
#define DAINTMSK_OEPM_EP3 (0x4UL << DAINTMSK_OEPM_POS)
...
/* STUPCNT AND RXPID ARE JUST ALIASES. JUST DIFFERENT NAMES. SEE RM0383 */
#define DOEPTSIZ_STUPCNT_POS (29U)
#define DOEPTSIZ_RXPID_POS   DOEPTSIZ_STUPCNT_POS
#define DOEPTSIZ_STUPCNT_MSK (0X3UL << DOEPTSIZ_STUPCNT_POS)
#define DOEPTSIZ_RXPID_MSK   (0x3UL << DOEPTSIZ_RXPID_POS)
#define DOEPTSIZ_STUPCNT     DOEPTSIZ_STUPCNT_MSK
#define DOEPTSIZ_RXPID       DOEPTSIZ_RXPID_MSK
