 ...
 * 
 *        @note Just like with microJson, the user must layout the expected JSON
 ...
 * 
 * SPDX-License-Identifier: BSD-2-Clause In Addition to any provisions in
 *  the original source license (Copyright (c) 2014 by Eric S. Raymond)
 */
